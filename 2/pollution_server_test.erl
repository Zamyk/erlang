...
get_min_and_max_test() ->
  ...
  pollution_server:add_value("Stacja 1", {{2023,3,27},{11,16,16}}, "PM10", 2000),
  pollution_server:add_value("Stacja 2", {{2023,3,28},{11,16,17}}, "PM10", 3000),

  pollution_server:add_value("Stacja 3", {{2023,3,27},{11,16,18}}, "PM10", 1234),

  ?assertMatch({10, 2000}, pollution_server:get_min_and_max("Stacja 1", "PM10", {2023,3,27})),
  ?assertMatch({3000, 3000}, pollution_server:get_min_and_max("Stacja 2", "PM10", {2023,3,28})).
...
get_min_and_max_fail_test() ->
  ...
  pollution_server:add_station("Stacja 1", {1,1}),
  pollution_server:get_state(),
    ?assertMatch({error, _}, pollution_server:get_min_and_max("Stacja 1", "PM25", {2023,3,27})),
  ?assertMatch({error, _}, pollution_server:get_min_and_max("Stacja 7", "PM10", {2023,3,29})).